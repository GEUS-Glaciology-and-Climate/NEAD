...
required_header  ::= ('field_delimiter' whitespace '=' whitespace field_delimiter) |
                     ('fields' whitespace '=' whitespace values)
field_delimiter  ::= [,|\/:;]


recommended_header ::= (( 'station_id' | 'nodata' | 'srid' | 'geometry' | 'tz') whitespace '=' whitespace value) |
                       ( 'add_value' | 'scale_factor' | 'display_units' ) whitespace '=' whitespace values
...
datalines       ::= value ( field_delimiter value )*
